...
Other docs: **[SETUP.md](SETUP.md)** to install and run · **[WORKFLOW.md](WORKFLOW.md)** for the execution map — what runs, in what order, calling what · **[DESIGN_NOTES.md](DESIGN_NOTES.md)** for the design decisions, their trade-offs, and what is deliberately not built yet.
